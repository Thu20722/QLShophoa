...
<div >
  ...
  <table class="table ">
    ...
    <tr>
      <td><?=$count?></td>
      <td><img height='120px' src='<?=$row["product_image"]?>'></td>
  ...
  <button type="button" class="btn btn-secondary" name="product_xml.php"  style="height:40px; width: 100px;  background-color: #207E6C;">  <a style="text-decoration: none ; color: #FFFFFF" href="product_xml.php">XML</a></button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' onsubmit="addItems()" method="POST">
            ...
            <div class="form-group">
              <button type="button" onclick="addItems()" data-dismiss="modal" class="btn btn-secondary" id="upload" style="height:60px; width: 140px;;  background-color: #E87C8C; ">Add Item</button>
            </div>
          </form>
        </div>
