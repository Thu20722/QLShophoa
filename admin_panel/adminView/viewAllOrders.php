<div id="ordersBtn" >
  ...
  <button type="button" class="btn btn-secondary" name="product_xml.php"  style="height:40px; width: 100px;  background-color: #207E6C; ">  <a style="text-decoration: none ; color: #FFFFFF" href="Order_xml.php">XML</a></button>
