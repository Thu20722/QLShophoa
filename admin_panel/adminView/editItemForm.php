...
<form id="update-Items" onsubmit="updateItems()" enctype='multipart/form-data'>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
         ...
         <div>
            <label for="file" style="padding: 10px";>Choose Image:</label>
            <input type="text" id="existingImage" class="form-control" value="<?=$row1['product_image']?>" hidden>
            <input type="file" id="newImage" value="">
         </div>
    </div>
    <div class="form-group">
      <button type="button" onclick="updateItems()"  style="height:60px; width: 140px;;  background-color: #E87C8C;" class="btn btn-primary">Update Item</button>
    </div>
    <?php
    		}
    	}
