...
<div >
  ...
  <button type="button" class="btn btn-secondary" style="height:40px; background-color:#23806E" data-toggle="modal" data-target="#myModal">
    Add Category
  </button><button type="button" class="btn btn-secondary"name="product_xml.php"  style="height:40px; width: 100px;  background-color: #207E6C; margin-left: 10px;">  <a style="text-decoration: none ; color: #FFFFFF" href="categories_xml.php">XML</a></button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="form-group">
              <button class="btn btn-secondary" data-dismiss="modal" type="button" onclick="addCat()" style="height:60px; width: 140px;;  background-color: #E87C8C;">Add Category</button>
            </div>
          </form>
