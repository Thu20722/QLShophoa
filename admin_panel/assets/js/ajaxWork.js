...
//add Cat data
function addCat(){
    var c_nameValue = document.getElementById("c_name").value;

    if (c_nameValue.trim() !== "") {
        $.ajax({
            url:"./controller/addCatController.php",
            method:"post",
            data:{record:c_nameValue},
            success:function(data){
                alert('Thanh Cong')
                $('form').trigger('reset');
                showCategory();
...
function addVariations(){
    var productV = document.getElementById("product").value;
    var sizeV = document.getElementById("size").value;
    var qtyV = document.getElementById("qty").value;

    if (productV.trim() !== "") {
        $.ajax({
            url:"./controller/addVariationController.php",
            method:"post",
            data: {
                record1: productV,
                record2: sizeV,
...
function addSize(){
    var c_sizeValue = document.getElementById("c_size").value;

    if (c_sizeValue.trim() !== "") {
        $.ajax({
            url:"./controller/addSizeController.php",
            method:"post",
            data:{record:c_sizeValue},
            success:function(data){
                alert('Thanh Cong')
                $('form').trigger('reset');
                showSizes();
